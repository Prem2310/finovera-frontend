                ...
                <div className="overflow-y-auto p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                            ...
                            <div
                                className={`text-xl font-bold flex items-center ${data.total_profit_loss < 0 ? "text-red-600" : "text-green-600"
                                    }`}
                            >
                        ...
                        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                            ...
                            <div
                                className={`text-xl font-bold flex items-center ${data.total_pnl_percentage < 0
                                    ? "text-red-600"
                                    : "text-green-600"
                                    }`}
                            >
